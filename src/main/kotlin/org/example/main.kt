...
fun main(args: Array<String>) {
    ...
    run(arrayOf("map", "map-120-n-30.csv", "120", "-1", "30", "false"))
    run(arrayOf("map", "map-20-n-80.csv", "20", "-1", "80", "false"))
    run(arrayOf("map", "map-10-70-n.csv", "10", "70", "-1", "false"))
    run(arrayOf("map", "map-50-20-n.csv", "50", "20", "-1", "false"))
}
